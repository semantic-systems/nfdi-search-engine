...
def search(search_term: str, results):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            logger.info(f'OPENALEX Publications - {total_hits} hits found')           
            ...
            if int(total_hits) > 0:
                ...
                for hit in hits:
                        ...
                        publication.url = hit.get("id", "") # not a valid url, openalex is currently working on thier web interface.
