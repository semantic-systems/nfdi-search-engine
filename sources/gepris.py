...
class GEPRIS(BaseSource):
    ...
    def extract_hits(self, raw: Dict[str, Any]) -> Iterable[Dict[str, Any]]:
        ...
        if projects:
            ...
            self.log_event(type="info", message=f'{self.SOURCE} - Got {len(entries)} {raw["context"]} records')
            return entries
        else:
    ...
    def map_hit(self, source_name: str, hit: Dict[str, Any]):
        ...
        try:
            ...
            self.log_event(type="warning", message=f"{self.SOURCE} - Key error while processing project: {e}. Skipping project.")
            return None
        except AttributeError as e:
            self.log_event(type="warning", message=f"{self.SOURCE} - Attribute error while processing project: {e}. Skipping project.")
            return None
    ...
    def extract_researcher_hits(self, raw: Dict[str, Any]) -> Iterable[Dict[str, Any]]:
        ...
        if authors_element:
            ...
            self.log_event(type="info", message=f'{self.SOURCE} - Got {len(authors)} author records')
            return authors
        else:
            self.log_event(type="info", message=f'{self.SOURCE} - No authors found in results')
            return []
    ...
    def map_researcher_hit(self, hit: Dict[str, Any]) -> Author:
        ...
        try:
            ...
            self.log_event(type="warning", message=f"{self.SOURCE} - Key 'href' not found in 'a' tag. Skipping author.")
            return None
        except AttributeError:
            self.log_event(type="warning", message=f"{self.SOURCE} - Unable to find author for the search term")
            return None
        except Exception as e:
    ...
    def extract_organization_hits(self, raw: Dict[str, Any]) -> Iterable[Dict[str, Any]]:
        ...
        if organization_list:
            ...
            self.log_event(type="info", message=f'{self.SOURCE} - Got {len(organizations)} organization records')
            return organizations
        else:
            self.log_event(type="info", message=f'{self.SOURCE} - No organizations found in results')
            return []
    ...
    def map_organization_hit(self, hit: Dict[str, Any]) -> Organization:
        ...
        try:
            ...
            self.log_event(type="warning", message=f"{self.SOURCE} - Key not found.")
            return None
        except AttributeError:
            self.log_event(type="warning", message=f"{self.SOURCE} - Unable to find organization details")
            return None
        except Exception as e:
    ...
    def search(self, source_name: str, search_term: str, results: dict, failed_sources: list) -> None:
        ...
        try:
            ...
            self.log_event(type="error", message=f'{self.SOURCE} - Error searching researchers: {e}')
        ...
        try:
            ...
            self.log_event(type="error", message=f'{self.SOURCE} - Error searching organizations: {e}')
        ...
        try:
            ...
            self.log_event(type="error", message=f'{self.SOURCE} - Error searching projects: {e}')


    def org_details(self, organization_id, organization_name):
        """
        ...
        try:
            ...
            self.log_event(type="error", message=f'Timed out Exception: {str(ex)}')
            # when timeout exception is true "GEPRIS" will be returned
            return 'GEPRIS'
            
        except Exception as ex:
            self.log_event(type="error", message=f'Exception: {str(ex)}')
            return None
