...
import threading
import dblp, zenodo, openalex, resodate, wikidata, cordis, gesis, eudat
import details_page

logging.config.fileConfig(os.getenv('LOGGING_FILE_CONFIG', '/Users/jan/PycharmProjects/nfdi-search-engine/logging.conf'))
...
def sources():
    ...
    if request.method == 'GET':
        ...
        sources = [dblp, zenodo, openalex, resodate, wikidata, cordis, gesis,eudat]
