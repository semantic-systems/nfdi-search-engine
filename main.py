...
import threading
import dblp, zenodo, openalex, resodate, wikidata, cordis, gesis, eulg, orcid, gepris, ieee
import details_page
...
def sources():
    ...
    if request.method == 'GET':
        ...
        sources = [dblp, zenodo, openalex, resodate, wikidata, cordis, gesis, eulg, orcid, gepris, ieee]
