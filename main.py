...
from sources import cordis, gesis, orcid, gepris, eulg, re3data, piveau
...
def search_results():
    ...
    if request.method == 'GET':
        ...
        sources = [dblp_publications, openalex_publications, zenodo, wikidata_publications, resodate, oersi, ieee, eudat, openaire_products, re3data, piveau]
        # sources = [zenodo]
